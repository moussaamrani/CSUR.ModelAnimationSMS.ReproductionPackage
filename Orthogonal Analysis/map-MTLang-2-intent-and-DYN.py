...
MTLtype = ['FSM','REWRITE','KERMETA','PN','XTEND/JAVA','B','VARIOUS','OTHER']
...
a1.set_xlabel('')
a2.set_xlabel('MTL Cluster', size=18, labelpad=30, weight="bold")
...
# ============================
plt.show()
fig.savefig('map-MTLang-2-intent-and-DYN.pdf', dpi=200, bbox_inches='tight')
